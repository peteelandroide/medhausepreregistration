...
export const TVShowcaseVanessa: React.FC = () => {
    ...
    const heroSlideContent = (
        <div className="flex flex-col items-center justify-center h-full text-center px-8 py-4">
            ...
            {/* Feature Section: Dra. Vanessa Flórez */}
            <motion.div
            ...
            >
                <div className="flex flex-col gap-5 shrink-0">
                    <div className="w-56 h-56 rounded-[2.5rem] overflow-hidden border-2 border-mh-gold/30">
                        <img 
                            src="/dra-vanessa/dra-vanessa-1.jpeg" 
                            alt="Dra. Vanessa Flórez 1" 
